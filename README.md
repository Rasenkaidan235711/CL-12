...
## 1.概要
引数で指定した画像の左右反転画像を保存する python 3 で動作するプログラムです。
## 2.ソースコード
```python
# このプログラムは python3用です。
...
- 以下のように入力画像の左右反転画像が出力されます。
  ...
  | --- | --- |
  | <img width="640" height="468" alt="input" src="https://github.com/user-attachments/assets/1d5dc747-a025-4104-a91f-97cd36141e78" /> | <img width="640" height="468" alt="input - コピー" src="https://github.com/user-attachments/assets/c913a891-b466-42df-9eeb-a9ab76bd3aee" /> |
